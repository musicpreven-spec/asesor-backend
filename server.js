...
// Ejemplo de otra ruta (puedes ir agregando las que quieras)
app.get("/api/cartas", (req, res) => {
  res.json([
    { id: 1, titulo: "Carta A", descripcion: "Ejemplo de carta desde backend" },
    { id: 2, titulo: "Carta B", descripcion: "Otra carta más" }
  ]);
});
